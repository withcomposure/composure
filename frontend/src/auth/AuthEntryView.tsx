...
const providerIcons: Record<string, React.ReactNode> = {
  ...
  orcid: (
    <svg viewBox="0 0 24 24" className="h-4 w-4" aria-hidden="true">
      ...
      <path fill="#fff" d="M7.5 8.2h1.7V17H7.5zM8.35 6.8a1 1 0 110 2 1 1 0 010-2zM11.1 9.3h1.6v1.2h.03c.3-.6 1-1.3 2.1-1.3 2.2 0 2.6 1.5 2.6 3.4V17h-1.7v-3.8c0-.9 0-2-1.2-2-1.2 0-1.4 1-1.4 1.9V17h-1.7z" />
    </svg>
  ),
};
