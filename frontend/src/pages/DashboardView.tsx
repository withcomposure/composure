                  ...
                  <div className="grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-3">
                    {filteredPinned.map((project) => (
                      <div
                        ...
                        onDragEnd={onPinnedDragEnd}
                        onDragOver={(event) =>
                          onPinnedDragOver(event, project.id)
                        }
                        className={`group relative rounded-xl border border-cz-border bg-cz-surface p-4 text-left transition hover:border-cz-accent/30 hover:shadow-lg hover:shadow-black/20 focus-visible:outline-2 focus-visible:outline-cz-accent ${draggedPinnedId === project.id ? "scale-[0.98] opacity-70" : ""}`}
                      >
                  ...
                  <div className="overflow-hidden rounded-xl border border-cz-border bg-cz-surface">
                    {filteredPinned.map((project) => (
                      <div
                        ...
                        className={`group flex w-full items-center justify-between border-b border-cz-border px-4 py-3 text-left transition last:border-b-0 hover:bg-cz-surface-hover focus-visible:outline-2 focus-visible:outline-cz-accent ${draggedPinnedId === project.id ? "opacity-70" : ""}`}
                      >
                        <div className="min-w-0">
                          <div className="flex items-center">
                            <div className="truncate text-sm text-cz-text">
                              {project.title}
                            </div>
                  ...
                  <div className="grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-3">
                    {filteredProjects.map((project) => (
                      <div
                        ...
                        className="group relative rounded-xl border border-cz-border bg-cz-surface p-4 text-left transition hover:border-cz-accent/30 hover:shadow-lg hover:shadow-black/20 focus-visible:outline-2 focus-visible:outline-cz-accent"
                      >
                        {renderGridCommentBadge(project)}
                        <div className="flex items-start justify-between gap-2">
                          <div>
                  ...
                  <div className="overflow-hidden rounded-xl border border-cz-border bg-cz-surface">
                    {filteredProjects.map((project) => (
                      <div
                        ...
                        className="group flex w-full items-center justify-between border-b border-cz-border px-4 py-3 text-left last:border-b-0 hover:bg-cz-surface-hover focus-visible:outline-2 focus-visible:outline-cz-accent"
                      >
                        <div className="min-w-0">
                          <div className="flex items-center">
                            <div className="truncate text-sm text-cz-text">
                  ...
                  <div className="grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-3">
                    {filteredShared.map((project) => (
                      <div
                        ...
                        className="group relative rounded-xl border border-cz-border bg-cz-surface p-4 text-left hover:border-cz-accent/30 focus-visible:outline-2 focus-visible:outline-cz-accent"
                      >
                        {renderGridCommentBadge(project)}
                        <div className="flex items-start justify-between gap-2">
                          <div className="line-clamp-1 text-sm font-medium text-cz-text">
                        ...
                        <div className="mt-3 text-xs text-cz-text-muted">
                          Last active {fmtRelativeTime(project.lastActiveAt)}
                        </div>
